...
class GoogleCloud(AbstractPlatform):
    def __init__(self, model_path, prefix_params, git_url, commit_sha, github_token, region="us-west2"):
    ...
    def train(self):
        ...
        command = ['sh', execution_script_path, self.git_url, self.commit_sha,
            self.github_token, self.model_path, self.prefix_params, self.region]
